...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          <img src="banner.jpg" alt="Lights" style="width:100%" style="height: 150px">
          <div class="w3-display-middle w3-large" > <h1 >Welcome to Payroll system</h1></div>
      </div>
   <div class="w3-display-container w3-text-white">
  <img src="payroll1.jpg" alt="Lights" style="width:100%">
  ...
  <p>Welcome to payroll system. This is our homepage. We are developing this site.</p></div>
